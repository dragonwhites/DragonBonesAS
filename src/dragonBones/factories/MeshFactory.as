package dragonBones.factories
{
	...
	*/
	 ...
	 * @see dragonBones.Armature
	 */
	public class MeshFactory extends BaseFactory
	{
		/**
...
//				_helpMatrix.d = 1;
		...
		{
			var armature:Armature = new Armature(new MeshArmature());
		...
		{
			var armature:FastArmature = new FastArmature(new MeshArmature());
			return armature;
		}
		...
		override protected function generateDisplay(textureAtlas:Object, fullName:String, pivotX:Number, pivotY:Number):Object
		{
			...
			if (subTexture)
			{
				var image:MeshQuadImage = new MeshQuadImage(subTexture);
